...
export default function Layout() {
    ...
    const [values, setValues] = useState({ botName: "",
                                        uploadExcelFile: "",
        ...
        <Grid container style={{
            ...
            <Grid item xs={12} sm={6}>
                <Box color="secondary.contrastText" style={{
                    ...
                    {checked ?
                        <Fade in={checked}>
                            <AdvSettings values={values} setValues={(e) =>{ handleInputchange(e)}} onClick={handleChange}></AdvSettings>
                        </Fade>
                        :
                        <Fade in={!checked}>
                            <Paper elevation={40} className={classes.paper}
                                ...
                                <BeginForm values={values} setValues={(e) =>{ handleInputchange(e)}}  advSettings={() => { setChecked(true) }} onClick={handleChange}>
                                </BeginForm>
                            </Paper>
                        </Fade>
                    }
